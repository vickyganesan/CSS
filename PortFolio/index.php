...
<body>
  ...
  <!-- Hero Section -->\
  <?php
  include('blocks/about-block.php');
  include('blocks/team-block.php');
  include('blocks/skills-block.php');
  include('blocks/portfolio-block.php');
  include('blocks/contact-block.php');
  include('blocks/footer-block.php');
  ?>
